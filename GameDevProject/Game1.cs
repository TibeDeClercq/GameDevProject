...
namespace GameDevProject
{
    public class Game1 : Game
    {
        ...
        {
            string[,] test = {
                                { "G1", "G1", "G1", "G1", "G1", "G1","A1", "A2", "A3", "G1", "G1", "G1"},
                                { "G1", "G1", "G1", "G1", "G1", "G1","B1", "G1", "B3", "G1", "G1", "G1"},
                                { "G1", "G1", "G1", "G1", "A1", "A2","G1", "C2", "C3", "G1", "G1", "G1"},
                                { "G1", "G1", "G1", "G1", "A2", "G1","B3", "G1", "G1", "G1", "G1", "G1"},
                                { "G1", "G1", "A1", "A2", "G1", "G1","B3", "G1", "G1", "G1", "G1", "G1"},
                                { "G1", "G1", "B1", "G1", "G1", "G1","B3", "G1", "G1", "G1", "G1", "G1"},

    ...
    public class Game1 : Game
    {
        ...
        private void LoadLevel1()
        {
            ...
            string[,] map = {
                                ...
                                { "B1", "B3", "F4", "G1", "G1", "G1", "F4", "B4", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "F4", "B1", "E3", "E3", "E3", "B3", "G1", "G1", "G1", "G1", "B1", "B3", "F4", "G1", "G1", "G1", "G1", "B1", "B3"},
                                { "B1", "B3", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D2", "D3", "D5", "D6", "D7", "B1", "B3"},
                                { "B1", "B3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "B1", "B3"},
                                { "B1", "B3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "B1", "B3"},
                                { "B1", "B3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "D1", "D2", "D2", "D2", "D2", "D2", "D3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "A4", "D5", "D6", "D7", "B1", "B3"},
                                { "B1", "B3", "G1", "G1", "G1", "G1", "A1", "A2", "A3", "D5", "G1", "G1", "G1", "A1", "A2", "A3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "A1", "B3", "G1", "G1", "G1", "B1", "B3"},
                                { "B1", "B3", "G1", "G1", "G1", "G1", "B1", "E3", "B3", "F4", "F4", "F4", "F4", "B1", "E3", "B3", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "G1", "F4", "G1", "G1", "G1", "G1", "G1", "A1", "F2", "B3", "F4", "F4", "F4", "B1", "B3"},
                                { "B1", "F1", "A2", "A2", "A2", "A2", "F2", "E3", "F1", "A2", "A2", "A2", "A2", "F2", "E3", "F1", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "A2", "F2", "E3", "F1", "A2", "A2", "A2", "F2", "B3"},
        ...
        private List<Coin> GetLevel1Coins()
        {
            ...
            coins.Add(new Coin(this.coinTextures, new Vector2(7, 12)));
            ...
            coins.Add(new Coin(this.coinTextures, new Vector2(3, 12)));
        ...
        private List<Enemy> GetLevel1Enemies(Player player)
        {
            ...
            enemies.Add(new Type1Enemy(this.type1EnemyTextures, player, new Vector2(19, 4)));
            enemies.Add(new Type1Enemy(this.type1EnemyTextures, player, new Vector2(22, 4)));
